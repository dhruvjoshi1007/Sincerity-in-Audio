...
folder_data   = './audio_new/'  # folder with audio (.wav) files
exe_opensmile = './opensmile-2.3.0/bin/linux_x64_standalone_static/SMILExtract'  # MODIFY this path to the folder of the SMILExtract (version 2.3) executable
...
if feature_type=='mfcc':
    ...
    conf_smileconf = path_config + 'IS13_ComParE.conf'
    ...
    folder_output = './audio_features_egemaps_2/'  # output folder
